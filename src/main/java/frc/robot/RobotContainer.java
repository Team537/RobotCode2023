...
public class RobotContainer {
        ...
        public RobotContainer() {
                ...
                final ChaseTagCommand chaseTagCommand = new ChaseTagCommand(m_camera, m_robotDrive,
                                m_camera::getRobotPose2d);

                leftStick.toggleOnTrue(new BalanceChargeStation(m_robotDrive, false));

                rightStick.toggleOnTrue(
                                new StartEndCommand(m_camera::CameraToAprilTag, m_camera::CameraPipeline, m_camera));
                // Toggle Booleans
