...
// Makes the main class of the file (everything in the file goes in this)(works
// like a file itself)
public class Constants {
  ...
  public static final class GripperConstants {
    ...
    // TODO: set temporary variables on an interface/dashboard
  ...
  public static final class ArmPivotConstants {
    ...
    // This is the position for moving tht arm down a bit when scoring mid. via Main
    // Driver's prefrences
  ...
  public static final class WristConstants {
    ...
    // Wrist zero and ground positions
  ...
  // Holds methods for metric & imperial conversions
  ...
  // Sets variables for camera and field positions
  ...
  // Sets Contansts used in swerve drive
  public static class SwerveConstants {
    ...
    public static final TrapezoidProfile.Constraints kRotControllerConstraints = 
      new TrapezoidProfile.Constraints(kMaxRotationRadiansPerSecond, kMaxRotationRadiansPerSecondSquared);
