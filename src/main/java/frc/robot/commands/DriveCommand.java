...
public class DriveCommand extends CommandBase {
  ...
  public DriveCommand(Supplier<Double> xSpeed, Supplier<Double> ySpeed, Supplier<Double> rot, boolean fieldRelative, DriveSubsystem m_drive) {
  ...
  @Override
  public void execute() {
    double realTimeX = xSpeed.get();
    double realTimeY = ySpeed.get();
