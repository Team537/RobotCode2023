...
public class ScoreHighCubeDriveBack extends SequentialCommandGroup {
  ...
  public ScoreHighCubeDriveBack(DriveSubsystem m_drive, FieldSim m_fieldSim,  ArmInOut m_ArmInOut, ArmPivot m_ArmPivot, GripperIntake m_Gripper, Wrist m_Wrist, LED m_LED) {
