...
public class Camera extends SubsystemBase {
    ...
    public double[] tagPosX = new double[10];
    ...
    public double[] getBotPose() {
        ...
        botPose = NetworkTableInstance.getDefault().getTable("limelight").getEntry("botpose")
                .getDoubleArray(defaultDoubleArray);
    ...
    public Pose2d[] getRobotPoses2d() {
        ...
        robotPosX = NetworkTableInstance.getDefault().getTable("limelight").getEntry("Robot Pose X")
                .getDoubleArray(new double[] {});
        robotPosY = NetworkTableInstance.getDefault().getTable("limelight").getEntry("Robot Pose Y")
                .getDoubleArray(new double[] {});
        robotPosYaw = NetworkTableInstance.getDefault().getTable("limelight").getEntry("Robot Pose Yaw")
                .getDoubleArray(new double[] {});
        poseArray = new Pose2d[robotPosX.length];
        for (int i = 0; i < robotPosX.length; i++)
            poseArray[i] = new Pose2d(robotPosX[i], robotPosY[i], Rotation2d.fromDegrees(robotPosYaw[i]));
        return poseArray;
    }
    ...
    public int[] getTagIds() {
        ...
        double[] rawTags = NetworkTableInstance.getDefault().getTable("limelight").getEntry("tid")
                .getDoubleArray(new double[] {});
