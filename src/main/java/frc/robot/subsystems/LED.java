...
public class LED extends SubsystemBase {
  ...
  // private AddressableLEDBuffer buffer = new
  ...
  public void setMode(LedMode mode) {
    switch (mode) {
      ...
      case DRIVING:
        // wave(Color.kLime, Color.kBlack, LEDConstants.waveAllianceFullLength,
        // LEDConstants. waveAllianceDuration);
        m_blinkin.set(-0.37);
        break;
  ...
  // boolean on =
  // ((Timer.getFPGATimestamp() % LEDConstants.strobeDuration) /
  // LEDConstants.strobeDuration) > 0.5;
  // setSolidColor(on ? color : Color.kBlack);
  // }

  // private void breath(Color c1, Color c2) {
  // double x = ((Timer.getFPGATimestamp() % LEDConstants.breathDuration) /
  ...
  // // buffer.setLED((LEDConstants.centerLed + index) % LEDConstants.length,
  // color);
  ...
  // ratio = (-Math.pow(Math.sin(x + Math.PI),LEDConstants. waveExponent) + 1.0) /
  // 2.0;
  // }
  // if (Double.isNaN(ratio)) {
  // ratio = 0.5;
  ...
  // Sets the variable in this file active based on another file's variable (
  // trace the method )
